...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let notesDataSource = CoreDataNotesDataSource()
        let repository = NotesRepositoryImp(notesDataSource: notesDataSource)
        let useCase = NotesUseCaseImp(notesRepository: repository)
        let notesViewModel = NotesViewModel(useCase: useCase)
